...
function init() {
  ...
  slide.setImage(l1.load('././margarot robbie.jpg'));
  root.scene.add(slide);

  var slide2 = new Slide(width, height, 'in');
  var l2 = new THREE.ImageLoader();
	l2.setCrossOrigin('Anonymous');
	slide2.setImage(l2.load('./birds-of-prey.jpg'));
  ...
  var l3 = new THREE.ImageLoader();
	...
	slide3.setImage(l3.load('./Assets/Images/icon.jpg'));
